...
test('phone UI is map-first and supports the core touch editing flow', async ({ page }, testInfo) => {
  ...
  await page.screenshot({ path: testInfo.outputPath('mobile-portrait.png'), fullPage: true });
