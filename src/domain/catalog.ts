...
export const ROOM_TYPES: RoomTypeMeta[] = [
  ...
  { id: 'dirty-bedroom', label: 'Dirty bedroom', icon: 'Z?', tone: 'bedroom', group: 'special' },
  { id: 'chest-room', label: 'Chest room', icon: '▣', tone: 'gold', group: 'special' },
  { id: 'mirror', label: 'Mirror room', icon: '◫', tone: 'secret', group: 'special' },
  { id: 'rails', label: 'Rails room', icon: '═', tone: 'neutral', group: 'special' },
  { id: 'teleporter', label: 'Teleporter room', icon: '◎', tone: 'dice', group: 'special' },
  ...
  { id: 'red-treasure', label: 'Red treasure', icon: '★R', tone: 'devil', group: 'hidden' },
  { id: 'silver-treasure', label: 'Silver treasure', icon: '★S', tone: 'gold', group: 'hidden' },
